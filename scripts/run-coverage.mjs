...
// matchMission and lightningCup have exhaustive suites but Vitest currently inlines these small modules,
// so Node V8 does not expose stable standalone script URLs for this collector.
