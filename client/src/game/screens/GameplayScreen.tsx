            ...
            {gridCoords.map(({ x, y }) => {
              ...
              return (
                ...
                >
                  ...
                  {/* One stable high-contrast ring identifies the selected target. */}
                  {isSelected && (
                    <div
                      data-selected-target="true"
                      aria-hidden="true"
                      style={{
                        position: "absolute",
                        inset: "8%",
                        ...
                        boxShadow: "0 0 0 2px rgba(255,255,255,0.88), 0 0 18px rgba(255,107,53,0.55)",
                        pointerEvents: "none",
                      }}
                    />
                  )}
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <label style={{ display: "block", marginTop: 6, color: "#D9DFFF", fontSize: 11, fontWeight: 800 }}>
                  ...
                  <span id="spin-control-help" className="sr-only">
                    Usa las flechas para cambiar la curva; Inicio centra a la izquierda y Fin a la derecha.
                  </span>
                  <input
                    ...
                    aria-describedby="spin-control-help"
                    style={{ display: "block", width: "100%", minWidth: 110, height: 44, accentColor: "#B388FF", touchAction: "manipulation" }}
                  />
                </label>
              </div>
              <motion.button
